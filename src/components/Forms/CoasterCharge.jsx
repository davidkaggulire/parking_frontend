...
import { coasterChargesURL } from "../../utils/APIRoutes";
...
const CoasterCharge = (props) => {
  ...
  const submitServiceHandler = (event) => {
    ...
    if (validate()) {
      ...
      dispatch(
        postCharge(chargeData, coasterChargesURL, navigate, setIsLoading, token)
      );
    }
  };
    ...
    <Fragment>
      ...
      <Modal onClose={props.onClose} className="top-[-96]">
        <div className="">
          ...
          <h1 className="text-center text-gray-700 text-xl">Add Coaster charge</h1>
